...
class LanguageProvider extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'logout': 'Logout',
      'search_funds_placeholder':
          'Type 3+ characters to search funds (e.g. Axis Bluechip, SBI Liquid)...',
      'search_funds_placeholder_client':
          'Enter at least 2 characters to search funds...',
      'no_fund_selected': 'No Fund Selected',
      'no_fund_selected_sub':
      ...
      'about_us_content':
          'Sharan Fincorp deals in Mutual Funds with more than 15 years of experience, delivering the best customer experience in the market.',
    ...
    'hi': {
      ...
      'mfd_qualification_queue': 'एमएफडी योग्यता कतार',
      ...
      'fund_facts_finder_sub':
          'रीयल-टाइम वर्गीकरण, आईएसआईएन कोड और ऐतिहासिक एनएवी डेटा देखने के लिए म्यूचुअल फंड का नाम टाइप करें।',
      ...
      'logout': 'लॉगआउट',
      'search_funds_placeholder':
          'फंड खोजने के लिए 3+ अक्षर टाइप करें (उदा. Axis Bluechip, SBI Liquid)...',
      'search_funds_placeholder_client':
          'फंड खोजने के लिए कम से कम 2 अक्षर दर्ज करें...',
      'no_fund_selected': 'कोई फंड नहीं चुना गया',
      'no_fund_selected_sub':
          'म्यूचुअल फंड की मेटा जानकारी और ऐतिहासिक एनएवी डेटा देखने के लिए खोजें और चुनें।',
      'light_mode': 'लाइट मोड',
      ...
      'about_us_content':
          'शरण फिनकॉर्प म्यूचुअल फंड के क्षेत्र में 15 से अधिक वर्षों के अनुभव के साथ काम करता है, जो बाजार में सर्वोत्तम ग्राहक अनुभव प्रदान करता है।',
