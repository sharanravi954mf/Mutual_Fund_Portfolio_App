...
class ThemeProvider extends ChangeNotifier {
  ThemeModeOption _themeModeOption =
      ThemeModeOption.light; // Light mode by default!
  MoneyWallpaperOption _wallpaperOption = MoneyWallpaperOption
      .rupeeRain; // Live Money Wallpaper enabled by default!
...
class AppThemeColors {
  ...
  Color get primaryHover =>
      isDark ? AppColors.darkPrimary : AppColors.lightPrimaryHover;
  Color get secondary =>
      isDark ? AppColors.darkSecondary : AppColors.lightSecondary;
  Color get accent => isDark ? AppColors.darkAccent : AppColors.lightPrimary;
  Color get activeBackground => isDark
      ? AppColors.darkPrimary.withValues(alpha: 0.15)
      : AppColors.lightActiveBackground;
  ...
  Color get sidebarSurface =>
      isDark ? AppColors.darkSidebarSurface : AppColors.lightSidebarSurface;
  Color get sidebarActive =>
      isDark ? AppColors.darkSidebarActive : AppColors.lightSidebarActive;
  Color get sidebarTextPrimary => isDark
      ? AppColors.darkSidebarTextPrimary
      : AppColors.lightSidebarTextPrimary;
  Color get sidebarTextSecondary => isDark
      ? AppColors.darkSidebarTextSecondary
      : AppColors.lightSidebarTextSecondary;
  Color get sidebarBorder =>
      isDark ? AppColors.darkSidebarBorder : AppColors.lightSidebarBorder;
  ...
  Color get surfaceAccent =>
      isDark ? AppColors.darkSurfaceAccent : AppColors.lightSurfaceAccent;
  Color get tableRowAlt =>
      isDark ? AppColors.darkTableRowAlt : AppColors.lightTableRowAlt;
