                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      isDesktop
                          ...
                          : Column(
                              children: [
                                _buildMetricCard("Total Invested", currencyFormat.format(invested), Icons.account_balance_wallet_outlined, const Color(0xFF8A2387)),
                                const SizedBox(height: 14),
                                _buildMetricCard("Current Valuation", currencyFormat.format(current), Icons.trending_up, const Color(0xFFE94057)),
                                const SizedBox(height: 14),
                                _buildMetricCard("Absolute Return", "${absReturn.toStringAsFixed(2)}%", Icons.pie_chart_outline, const Color(0xFFF27121), isReturn: true, returnValue: absReturn),
                              ],
                            ),
