...
- [ ] **test(database/edge): add pgTAP and service-level tests for qualify_order, cancel_order, immutable audits, and Platform Admin overrides (includes tests for step-up requirement, override.attempted, override.denied, override.failed, attempt survival after rollback, correlation ID duplication, and canonical audit fields) [BRD-BR-003, BRD-BR-007, BRD-FR-005, Section 6.D, Section 6.E, Section 6.G, Section 17.F]** (#51)
