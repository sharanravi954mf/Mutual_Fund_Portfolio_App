...
| Provider response amplification | Bounded streamed JSON, message/attachment/part counts, field and identifier limits; Gmail defaults to at most 4 pages, 100 inspected candidates, 25 returned messages, and 5 concurrent detail requests (configurable 1–10) | Page listing stays sequential; detail-worker failures cancel and await siblings |
